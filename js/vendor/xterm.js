    ...
    var e = {
          ...
          let _ = (t.AccessibilityManager = class extends h.Disposable {
            constructor(e, t) {
              ...
              (this._terminal.element.insertAdjacentElement(
                ...
                this.register(this._terminal.onA11yChar((e) => this._handleChar(e))),
                this.register(this._terminal.onLineFeed(() => this._handleChar('\n'))),
                this.register(this._terminal.onA11yTab((e) => this._handleTab(e))),
            ...
            _handleBoundaryFocus(e, t) {
              ...
              if (
                (0 === t
                  ? ((r = i), (n = this._rowElements.pop()), this._rowContainer.removeChild(n))
                  : ((r = this._rowElements.shift()), (n = i), this._rowContainer.removeChild(r)),
                r.removeEventListener('focus', this._topBoundaryFocusListener),
                n.removeEventListener('focus', this._bottomBoundaryFocusListener),
                0 === t)
              ) {
        ...
        3614: (e, t) => {
          ...
          function r(e, t, r, n) {
            ((e = s(
              (e = i(e)),
              r.decPrivateModes.bracketedPasteMode && !0 !== n.rawOptions.ignoreBracketedPasteMode
            )),
          ...
          (Object.defineProperty(t, '__esModule', { value: !0 }),
            ...
            (t.paste = r),
            (t.moveTextAreaUnderMouseCursor = n),
            (t.rightClickHandler = function (e, t, i, s, r) {
          ...
          let c = (t.Linkifier2 = class extends a.Disposable {
            ...
            constructor(e) {
              (super(),
                ...
                (this._wasResized = !1),
                (this._activeLine = -1),
                (this._onShowLinkUnderline = this.register(new o.EventEmitter())),
                (this.onShowLinkUnderline = this._onShowLinkUnderline.event),
                (this._onHideLinkUnderline = this.register(new o.EventEmitter())),
                (this.onHideLinkUnderline = this._onHideLinkUnderline.event),
                this.register((0, a.getDisposeArrayDisposable)(this._linkCacheDisposables)),
                this.register(
                  (0, a.toDisposable)(() => {
            ...
            attachToDom(e, t, i) {
              ((this._element = e),
                ...
                this.register(
                  (0, n.addDisposableDomListener)(this._element, 'mouseleave', () => {
              ...
              for (const [i, n] of this._linkProviders.entries())
                t
                  ? (null === (s = this._activeProviderReplies) || void 0 === s
                      ? void 0
                      : s.get(i)) && (r = this._checkLinkProviderResult(i, e, r))
                  : n.provideLinks(e.y, (t) => {
                      ...
                      (null === (s = this._activeProviderReplies) || void 0 === s || s.set(i, o),
                        ...
                        (null === (n = this._activeProviderReplies) || void 0 === n
                          ? void 0
            ...
            _checkLinkProviderResult(e, t, i) {
              ...
              let n = !1;
              for (let t = 0; t < e; t++)
                (this._activeProviderReplies.has(t) && !this._activeProviderReplies.get(t)) ||
                  (n = !0);
              if (!n && r) {
              ...
              if (this._activeProviderReplies.size === this._linkProviders.length && !i)
                for (let e = 0; e < this._activeProviderReplies.size; e++) {
                  const r =
                    null === (s = this._activeProviderReplies.get(e)) || void 0 === s
                      ? void 0
              ...
              t &&
                ...
                (this._currentLink.state = {
                  decorations: {
                    ...
                    pointerCursor:
                      void 0 === e.link.decorations || e.link.decorations.pointerCursor,
                  },
                  isHovered: !0,
                }),
                ...
                Object.defineProperties(e.link.decorations, {
                  pointerCursor: {
                    get: () => {
                      var e, t;
                      return null ===
                        (t = null === (e = this._currentLink) || void 0 === e ? void 0 : e.state) ||
                        void 0 === t
                        ? void 0
                  ...
                  this._linkCacheDisposables.push(
                    this._renderService.onRenderedViewportChange((e) => {
                      ...
                      if (
                        ...
                        (this._clearCurrentLink(t, i), this._lastMouseEvent && this._element)
                      ) {
            ...
            _linkHover(e, t, i) {
              ...
              ((null === (s = this._currentLink) || void 0 === s ? void 0 : s.state) &&
                ...
                t.hover && t.hover(i, t.text));
            }
            _fireUnderlineEvent(e, t) {
              const i = e.range,
                s = this._bufferService.buffer.ydisp,
                r = this._createLinkUnderlineEvent(
                  i.start.x - 1,
                  i.start.y - s - 1,
                  i.end.x,
                  i.end.y - s - 1,
        ...
        3730: function (e, t, i) {
            ...
            provideLinks(e, t) {
              ...
              for (let t = 0; t < c; t++)
                if (-1 !== d || s.hasContent(t)) {
                  ...
                  if (_ || (-1 !== d && t === c - 1)) {
                    const s =
                      null === (i = this._oscLinkService.getLinkData(l)) || void 0 === i
                        ? void 0
                        : i.uri;
                    if (s) {
                      const i = {
          ...
          t.OscLinkProvider = a = s(
            [r(0, o.IBufferService), r(1, o.IOptionsService), r(2, o.IOscLinkService)],
            a
          );
        },
        6193: (e, t) => {
          ...
          class P extends y.CoreTerminal {
            ...
            constructor(e = {}) {
              (super(e),
                ...
                (this._accessibilityManager = this.register(new E.MutableDisposable())),
                ...
                this.register(
                  this._inputHandler.onRequestRefreshRows((e, t) => this.refresh(e, t))
                ),
                ...
                this.register(
                  (0, w.forwardEvent)(this._inputHandler.onCursorMove, this._onCursorMove)
                ),
                this.register(
                  (0, w.forwardEvent)(this._inputHandler.onTitleChange, this._onTitleChange)
                ),
                this.register(
                  (0, w.forwardEvent)(this._inputHandler.onA11yChar, this._onA11yCharEmitter)
                ),
                this.register(
                  (0, w.forwardEvent)(this._inputHandler.onA11yTab, this._onA11yTabEmitter)
                ),
                this.register(
                ...
                this.register(
                  (0, E.toDisposable)(() => {
                    ...
                    ((this._customKeyEventHandler = void 0),
                      null ===
                        (t = null === (e = this.element) || void 0 === e ? void 0 : e.parentNode) ||
                        void 0 === t ||
            ...
            _syncTextArea() {
              ...
              ((this.textarea.style.left = a + 'px'),
                ...
                (this.textarea.style.lineHeight = s + 'px'),
                (this.textarea.style.zIndex = '-5'));
            }
            _initGlobal() {
              (this._bindKeys(),
                this.register(
                  (0, r.addDisposableDomListener)(this.element, 'copy', (e) => {
                    this.hasSelection() && (0, s.copyHandler)(e, this._selectionService);
                  })
                ));
              const e = (e) =>
                (0, s.handlePasteEvent)(e, this.textarea, this.coreService, this.optionsService);
              (this.register((0, r.addDisposableDomListener)(this.textarea, 'paste', e)),
                ...
                k.isFirefox
                  ? this.register(
                      (0, r.addDisposableDomListener)(this.element, 'mousedown', (e) => {
                        2 === e.button &&
                          (0, s.rightClickHandler)(
                            e,
                            this.textarea,
                            this.screenElement,
                  ...
                  : this.register(
                      (0, r.addDisposableDomListener)(this.element, 'contextmenu', (e) => {
                        (0, s.rightClickHandler)(
                          e,
                          this.textarea,
                          this.screenElement,
                ...
                k.isLinux &&
                  this.register(
                    (0, r.addDisposableDomListener)(this.element, 'auxclick', (e) => {
                      1 === e.button &&
                        (0, s.moveTextAreaUnderMouseCursor)(e, this.textarea, this.screenElement);
                    })
                  ));
            }
            _bindKeys() {
              (this.register(
                (0, r.addDisposableDomListener)(this.textarea, 'keyup', (e) => this._keyUp(e), !0)
              ),
                this.register(
                ...
                this.register(
                  (0, r.addDisposableDomListener)(this.textarea, 'compositionstart', () =>
                    this._compositionHelper.compositionstart()
                  )
                ),
                this.register(
                  (0, r.addDisposableDomListener)(this.textarea, 'compositionupdate', (e) =>
                    this._compositionHelper.compositionupdate(e)
                  )
                ),
                this.register(
                  (0, r.addDisposableDomListener)(this.textarea, 'compositionend', () =>
            ...
            open(e) {
              ...
              ((this._viewportElement = O.createElement('div')),
                ...
                k.isChromeOS || this.textarea.setAttribute('aria-multiline', 'false'),
                this.textarea.setAttribute('autocorrect', 'off'),
                this.textarea.setAttribute('autocapitalize', 'off'),
                this.textarea.setAttribute('spellcheck', 'false'),
                (this.textarea.tabIndex = 0),
                (this._coreBrowserService = this._instantiationService.createInstance(
                  v.CoreBrowserService,
                  this.textarea,
                  null !== (t = this._document.defaultView) && void 0 !== t ? t : window
                )),
                this._instantiationService.setService(
                ...
                this.register(
                  (0, r.addDisposableDomListener)(this.textarea, 'focus', (e) =>
                    this._handleTextAreaFocus(e)
                  )
                ),
                this.register(
                  (0, r.addDisposableDomListener)(this.textarea, 'blur', () =>
                ...
                (this._themeService = this._instantiationService.createInstance(C.ThemeService)),
              ...
              (this._renderService.hasRenderer() ||
                ...
                (this._mouseService = this._instantiationService.createInstance(p.MouseService)),
                ...
                this._instantiationService.setService(S.ISelectionService, this._selectionService),
                this.register(
                ...
                this.register(
                  (0, r.addDisposableDomListener)(this._viewportElement, 'scroll', () =>
                ...
                this.optionsService.onSpecificOptionChange('overviewRulerWidth', (e) => {
            ...
            bindMouse() {
              ...
              function i(t) {
                ...
                switch (t.overrideType || t.type) {
                  case 'mousemove':
                    ((r = 32),
                      void 0 === t.buttons
                        ? ((s = 3), void 0 !== t.button && (s = t.button < 3 ? t.button : 3))
                        : (s = 1 & t.buttons ? 0 : 4 & t.buttons ? 1 : 2 & t.buttons ? 2 : 3));
                    break;
                  case 'mouseup':
              ...
              const s = { mouseup: null, wheel: null, mousedrag: null, mousemove: null },
                n = {
                  mouseup: (e) => (
                    i(e),
                    e.buttons ||
                      (this._document.removeEventListener('mouseup', s.mouseup),
                      s.mousedrag && this._document.removeEventListener('mousemove', s.mousedrag)),
                    this.cancel(e)
                  ),
              ...
              (this.register(
                this.coreMouseService.onProtocolChange((e) => {
                  (e
                    ...
                    8 & e
                      ? s.mousemove ||
                        (t.addEventListener('mousemove', n.mousemove), (s.mousemove = n.mousemove))
                      : (t.removeEventListener('mousemove', s.mousemove), (s.mousemove = null)),
                    16 & e
                      ? s.wheel ||
                        (t.addEventListener('wheel', n.wheel, { passive: !1 }), (s.wheel = n.wheel))
                      : (t.removeEventListener('wheel', s.wheel), (s.wheel = null)),
                    2 & e
                      ? s.mouseup ||
                        (t.addEventListener('mouseup', n.mouseup), (s.mouseup = n.mouseup))
                      : (this._document.removeEventListener('mouseup', s.mouseup),
                        t.removeEventListener('mouseup', s.mouseup),
                        (s.mouseup = null)),
                    4 & e
                      ? s.mousedrag || (s.mousedrag = n.mousedrag)
                      : (this._document.removeEventListener('mousemove', s.mousedrag),
                        (s.mousedrag = null)));
                })
              ),
                (this.coreMouseService.activeProtocol = this.coreMouseService.activeProtocol),
                this.register(
                  (0, r.addDisposableDomListener)(t, 'mousedown', (e) => {
                    if (
                      (e.preventDefault(),
                      this.focus(),
                      this.coreMouseService.areMouseEventsActive &&
                  ...
                  (0, r.addDisposableDomListener)(
                    ...
                    (e) => {
                      if (!this.coreMouseService.areMouseEventsActive)
                        return (this.viewport.handleTouchStart(e), this.cancel(e));
                    },
                    { passive: !0 }
                  )
                ),
                this.register(
                  (0, r.addDisposableDomListener)(
                    ...
                    (e) => {
                      if (!this.coreMouseService.areMouseEventsActive)
                        return this.viewport.handleTouchMove(e) ? void 0 : this.cancel(e);
                    },
                    { passive: !1 }
                  )
                ));
            ...
            _keyDown(e) {
              ...
              const i = (0, R.evaluateKeyboardEvent)(
                e,
                ...
                !!this._isThirdLevelShift(this.browser, e) ||
                  ...
                  !i.key ||
                    ...
                    (this._unprocessedDeadKey
                      ...
                      : ((i.key !== D.C0.ETX && i.key !== D.C0.CR) || (this.textarea.value = ''),
                        this._onKey.fire({ key: i.key, domEvent: e }),
                        this._showCursor(),
                        this.coreService.triggerDataEvent(i.key, !0),
            ...
            reset() {
              ...
              (this._setup(),
                super.reset(),
                null === (e = this._selectionService) || void 0 === e || e.reset(),
            ...
            (t.TimeBasedDebouncer = class {
              ...
              refresh(e, t, i) {
                ((this._rowCount = i),
                  ...
                  (this._rowEnd = void 0 !== this._rowEnd ? Math.max(this._rowEnd, t) : t));
                const s = Date.now();
                if (s - this._lastRefreshMs >= this._debounceThresholdMS)
                  ((this._lastRefreshMs = s), this._innerRefresh());
          ...
          let l = (t.Viewport = class extends h.Disposable {
            constructor(e, t, i, s, r, o, h, c) {
              (super(),
                ...
                (this._onRequestScrollLines = this.register(new a.EventEmitter())),
                ...
                this.register(
                  this._renderService.onDimensionsChange((e) => (this._renderDimensions = e))
                ),
                this._handleThemeChange(c.colors),
                this.register(c.onChangeColors((e) => this._handleThemeChange(e))),
                this.register(
            ...
            _innerRefresh() {
              if (this._charSizeService.height > 0) {
                ((this._currentRowHeight =
                  this._renderService.dimensions.device.cell.height / this._coreBrowserService.dpr),
              ...
              (this._viewportElement.scrollTop !== e &&
                ((this._ignoreNextScrollEvent = !0), (this._viewportElement.scrollTop = e)),
                (this._refreshAnimationFrame = null));
            }
            syncScrollArea(e = !1) {
            ...
            _smoothScroll() {
              ...
              ((this._viewportElement.scrollTop =
                ...
                Math.round(e * (this._smoothScrollState.target - this._smoothScrollState.origin))),
                e < 1
                  ? this._coreBrowserService.window.requestAnimationFrame(() =>
                      this._smoothScroll()
                    )
            ...
            _bubbleScroll(e, t) {
              ...
              return (
                !(
                  ...
                  (t > 0 && i < this._lastRecordedBufferHeight)
                  ...
                  ? ((this._smoothScrollState.startTime = Date.now()),
                    this._smoothScrollPercent() < 1
                      ? ((this._smoothScrollState.origin = this._viewportElement.scrollTop),
                        -1 === this._smoothScrollState.target
                          ? (this._smoothScrollState.target = this._viewportElement.scrollTop + t)
              ...
              if (0 !== e)
                if (this._optionsService.rawOptions.smoothScrollDuration) {
                  ...
                  ((this._smoothScrollState.startTime = Date.now()),
                    this._smoothScrollPercent() < 1
                      ? ((this._smoothScrollState.origin = this._viewportElement.scrollTop),
                        (this._smoothScrollState.target = this._smoothScrollState.origin + t),
                        (this._smoothScrollState.target = Math.max(
                          Math.min(
                            this._smoothScrollState.target,
                            this._viewportElement.scrollHeight
                        ...
                        this._smoothScroll())
                      : this._clearSmoothScrollState());
                } else this._onRequestScrollLines.fire({ amount: e, suppressScrollEvent: !1 });
            }
            ...
            getLinesScrolled(e) {
              ...
              return (
                e.deltaMode === WheelEvent.DOM_DELTA_PIXEL
                  ...
                  : e.deltaMode === WheelEvent.DOM_DELTA_PAGE && (t *= this._bufferService.rows),
                t
              );
            }
            _applyScrollModifier(e, t) {
              const i = this._optionsService.rawOptions.fastScrollModifier;
              return ('alt' === i && t.altKey) ||
                ('ctrl' === i && t.ctrlKey) ||
                ('shift' === i && t.shiftKey)
                ? e *
            ...
            handleTouchMove(e) {
              ...
              return (
                (this._lastTouchY = e.touches[0].pageY),
                0 !== t && ((this._viewportElement.scrollTop += t), this._bubbleScroll(e, t))
              );
            }
          });
          t.Viewport = l = s(
        ...
        3107: function (e, t, i) {
          ...
          let c = (t.BufferDecorationRenderer = class extends a.Disposable {
            constructor(e, t, i, s) {
              (super(),
                ...
                this.register(
                  (0, n.addDisposableDomListener)(window, 'resize', () => this._queueRefresh())
                ),
                this.register(
                  this._bufferService.buffers.onBufferActivate(() => {
            ...
            _createElement(e) {
              ...
              (s.classList.add('xterm-decoration'),
                ...
                (s.style.height =
                  (e.options.height || 1) * this._renderService.dimensions.css.cell.height + 'px'),
                (s.style.top =
            ...
            _refreshStyle(e) {
              ...
              if (t < 0 || t >= this._bufferService.rows)
                ...
                (i ||
                  ...
                  (i.style.top = t * this._renderService.dimensions.css.cell.height + 'px'),
          ...
          t.BufferDecorationRenderer = c = s(
            [r(1, h.IBufferService), r(2, h.IDecorationService), r(3, o.IRenderService)],
            c
          );
        },
        5871: (e, t) => {
          (Object.defineProperty(t, '__esModule', { value: !0 }),
            ...
            (t.ColorZoneStore = class {
              ...
              _lineAdjacentToZone(e, t, i) {
                return (
                  t >= e.startBufferLine - this._linePadding[i || 'full'] &&
                  t <= e.endBufferLine + this._linePadding[i || 'full']
                );
              }
              _addLineToZone(e, t) {
          ...
          let u = (t.OverviewRulerRenderer = class extends h.Disposable {
            ...
            _registerDimensionChangeListeners() {
              (this.register(
                ...
                this.register(
                  (0, o.addDisposableDomListener)(this._coreBrowseService.window, 'resize', () =>
                    this._queueRefresh(!0)
                  )
                ),
                this._queueRefresh(!0));
                ...
                if (!this._isComposing) {
                  ...
                  ((this._dataAlreadySent = i),
                    t.length > e.length
                      ...
                      : t.length < e.length
                        ? this._coreService.triggerDataEvent(`${a.C0.DEL}`, !0)
                        : t.length === e.length &&
                          t !== e &&
              ...
              if (this._isComposing) {
                if (this._bufferService.buffer.isCursorInViewport) {
                  ...
                  ((this._textarea.style.left = s + 'px'),
                    ...
                    (this._textarea.style.lineHeight = r.height + 'px'));
                }
        ...
        9806: (e, t) => {
          ...
          (Object.defineProperty(t, '__esModule', { value: !0 }),
            ...
            (t.getCoords = function (e, t, s, r, n, o, a, h, c) {
              if (!o) return;
              const l = i(e, t, s);
              return l
        ...
        9504: (e, t, i) => {
          ...
          function n(e, t) {
            ...
            for (; r && e >= 0 && e < t.rows;)
              (i++, (s = t.buffer.lines.get(--e)), (r = null == s ? void 0 : s.isWrapped));
            return i;
          }
          function o(e, t) {
            return e > t ? 'A' : 'B';
          ...
          function a(e, t, i, s, r, n) {
            ...
            for (; o !== i || a !== s;)
              ((o += r ? 1 : -1),
                r && o > n.cols - 1
                  ? ((h += n.buffer.translateBufferLineToString(a, !1, e, o)),
                    (o = 0),
                    (e = 0),
                    a++)
                  : !r &&
                    o < 0 &&
                    ((h += n.buffer.translateBufferLineToString(a, !1, 0, e + 1)),
                    (o = n.cols - 1),
                    (e = o),
                    a--));
          ...
          t.moveToCellSequence = function (e, t, i, s) {
            const o = i.buffer.x,
              l = i.buffer.y;
            if (!i.buffer.hasScrollback)
              return (
                (function (e, t, i, s, o, l) {
                  return 0 === r(t, s, o, l).length
                    ? ''
                    : c(a(e, t, e, t - n(t, o), !1, o).length, h('D', l));
                })(o, l, 0, t, i, s) +
                r(l, t, i, s) +
                (function (e, t, i, s, o, l) {
                  let d;
                  ...
                  const _ = s,
                    u = (function (e, t, i, s, o, a) {
                      let h;
                      return (
                        (h = r(i, s, o, a).length > 0 ? s - n(s, o) : t),
                        (e < i && h <= s) || (e >= i && h < s) ? 'C' : 'D'
                      );
                    })(e, t, i, s, o, l);
            ...
            b = (t.DomRenderer = class extends _.Disposable {
              constructor(e, t, i, s, r, a, c, l, u, p) {
                (super(),
                  ...
                  (this._rowElements = []),
                  (this.onRequestRedraw = this.register(new d.EventEmitter()).event),
                  (this._rowContainer = document.createElement('div')),
                  ...
                  (this._rowFactory = r.createInstance(n.DomRendererRowFactory, document)),
              ...
              handleSelectionChanged(e, t, i) {
                if (
                  ...
                  this._rowFactory.handleSelectionChanged(e, t, i),
                ...
                if (i) {
                  const i = e[0] > t[0];
                  a.appendChild(
                    this._createSelectionElement(n, i ? t[0] : e[0], i ? e[0] : t[0], o - n + 1)
                  );
                } else {
                  const i = s === n ? e[0] : 0,
                  ...
                  if (
                    (a.appendChild(
                      this._createSelectionElement(n + 1, 0, this._bufferService.cols, c)
                    ),
                    n !== o)
                  ) {
              ...
              _createSelectionElement(e, t, i, s = 1) {
                ...
                return (
                  ...
                  (r.style.width = this.dimensions.css.cell.width * (i - t) + 'px'),
                  r
                );
              }
              handleCursorMove() {}
              ...
              _setCellUnderline(e, t, i, s, r, n) {
                ...
                ((i = Math.max(Math.min(i, o), 0)),
                  (s = Math.max(Math.min(s, o), 0)),
                  (r = Math.min(r, this._bufferService.cols)));
          ...
          let f = (t.DomRendererRowFactory = class {
            ...
            createRow(e, t, i, s, r, a, h, l, _, f, p) {
              ...
              for (let M = 0; M < b; M++) {
                ...
                if (
                  (' ' === N && (I.isUnderline() || I.isOverline()) && (N = ' '),
                  (A = b * l - _.get(N, I.isBold(), I.isItalic())),
                  C)
                ) {
                  if (
                    y &&
                ...
                (I.isOverline() && (B.push('xterm-overline'), ' ' === w && (w = ' ')),
                ...
                switch (
                  (this._decorationService.forEachDecorationAtCell(M, t, void 0, (e) => {
                    ('top' !== e.options.layer && J) ||
                      (e.backgroundColorRGB &&
                        ((K = 50331648),
                        (z = (e.backgroundColorRGB.rgba >> 8) & 16777215),
                        (V = e.backgroundColorRGB)),
                      e.foregroundColorRGB &&
                        ((j = 50331648),
                        ($ = (e.foregroundColorRGB.rgba >> 8) & 16777215),
                        (G = e.foregroundColorRGB)),
                      (J = 'top' === e.options.layer));
                  }),
                  !J &&
                    H &&
                  ...
                  case 50331648:
                    ((X = c.rgba.toColor(z >> 16, (z >> 8) & 255, 255 & z)),
                      this._addStyle(C, `background-color:#${v((z >>> 0).toString(16), '0', 6)}`));
                    break;
                  default:
                    q
                      ? ((X = S.foreground), B.push(`xterm-bg-${n.INVERTED_DEFAULT_COLOR}`))
                      : (X = S.background);
                }
                switch ((V || (I.isDim() && (V = c.color.multiplyOpacity(X, 0.5))), j)) {
                  ...
                  case 33554432:
                    (I.isBold() &&
                      ...
                      this._optionsService.rawOptions.drawBoldTextInBrightColors &&
                      ($ += 8),
                      this._applyMinimumContrast(C, X, S.ansi[$], I, V, void 0) ||
                        B.push(`xterm-fg-${$}`));
                    break;
                  case 50331648:
                    const e = c.rgba.toColor(($ >> 16) & 255, ($ >> 8) & 255, 255 & $);
                    this._applyMinimumContrast(C, X, e, I, V, G) ||
                      this._addStyle(C, `color:#${v($.toString(16), '0', 6)}`);
                    break;
                  default:
                    this._applyMinimumContrast(C, X, S.foreground, I, V, void 0) ||
                      (q && B.push(`xterm-fg-${n.INVERTED_DEFAULT_COLOR}`));
                }
                (B.length && ((C.className = B.join(' ')), (B.length = 0)),
                  F || O || U ? (C.textContent = w) : y++,
                  A !== this.defaultSpacing && (C.style.letterSpacing = `${A}px`),
                  g.push(C),
                  (M = P));
              }
            ...
            _isCellInSelection(e, t) {
              ...
              return (
                ...
                (this._columnSelectMode
                  ? i[0] <= s[0]
                    ? e >= i[0] && t >= i[1] && e < s[0] && t <= s[1]
                    : e < i[0] && t >= i[1] && e >= s[0] && t <= s[1]
                  : (t > i[1] && t < s[1]) ||
                    (i[1] === s[1] && t === i[1] && e >= i[0] && e < s[0]) ||
                    (i[1] < s[1] && t === s[1] && e < s[0]) ||
                    (i[1] < s[1] && t === i[1] && e >= i[0]))
              );
            }
            ...
            (t.WidthCache = class {
              ...
              setFont(e, t, i, s) {
                (e === this._font &&
                  ...
                  (this._measureElements[0].style.fontWeight = `${i}`),
                  (this._measureElements[1].style.fontWeight = `${s}`),
                  (this._measureElements[2].style.fontWeight = `${i}`),
                  (this._measureElements[3].style.fontWeight = `${s}`),
                  this.clear());
              }
              get(e, t, i) {
                let s = 0;
            ...
            static _mergeRanges(e, t) {
              ...
              for (let s = 0; s < e.length; s++) {
                ...
                if (i) {
                  ...
                  if (t[1] <= r[1])
                    return ((e[s - 1][1] = Math.max(t[1], r[1])), e.splice(s, 1), e);
                  (e.splice(s, 1), s--);
                } else {
          ...
          let u = (t.RenderService = class extends l.Disposable {
            ...
            constructor(e, t, i, s, r, h, _, u) {
              if (
                ...
                (this._onDimensionsChange = this.register(new c.EventEmitter())),
                (this.onDimensionsChange = this._onDimensionsChange.event),
                (this._onRenderedViewportChange = this.register(new c.EventEmitter())),
                ...
                (this._renderDebouncer = new o.RenderDebouncer(_.window, (e, t) =>
                ...
                this.register(r.onDecorationRegistered(() => this._fullRefresh())),
                this.register(r.onDecorationRemoved(() => this._fullRefresh())),
                this.register(
                  i.onMultipleOptionChange(
                    [
                      'customGlyphs',
            ...
            _handleIntersectionChange(e) {
              ((this._isPaused =
                void 0 === e.isIntersecting ? 0 === e.intersectionRatio : !e.isIntersecting),
                this._isPaused ||
                  this._charSizeService.hasValidSize ||
                  this._charSizeService.measure(),
                !this._isPaused &&
            ...
            refreshRows(e, t, i = !1) {
              this._isPaused
                ...
                : (i || (this._isNextRenderRedrawOnly = !1),
          ...
          let g = (t.SelectionService = class extends l.Disposable {
            constructor(e, t, i, s, r, n, o, h, d) {
              (super(),
                ...
                this.enable(),
                (this._model = new a.SelectionModel(this._bufferService)),
            ...
            _areCoordsInSelection(e, t, i) {
              return (
                (e[1] > t[1] && e[1] < i[1]) ||
                (t[1] === i[1] && e[1] === t[1] && e[0] >= t[0] && e[0] < i[0]) ||
            ...
            _selectWordAtCursor(e, t) {
              ...
              const r =
                null ===
                  (s =
                    null === (i = this._linkifier.currentLink) || void 0 === i ? void 0 : i.link) ||
                void 0 === s
                  ? void 0
                  : s.range;
              if (r)
            ...
            _getMouseEventScrollAmount(e) {
              let t = (0, n.getCoordsRelativeToElement)(
            ...
            shouldColumnSelect(e) {
              return (
                e.altKey &&
                !(d.isMac && this._optionsService.rawOptions.macOptionClickForcesSelection)
              );
            }
            _handleMouseMove(e) {
              ...
              (2 === this._activeSelectionMode
                ...
                : 1 === this._activeSelectionMode && this._selectToWordAt(this._model.selectionEnd),
            ...
            _dragScroll() {
              if (
                ...
                (this._dragScrollAmount > 0
                  ...
                  : (3 !== this._activeSelectionMode && (this._model.selectionEnd[0] = 0),
              ...
              if (
                ...
                if (this._bufferService.buffer.ybase === this._bufferService.buffer.ydisp) {
                  ...
                  if (t && void 0 !== t[0] && void 0 !== t[1]) {
                    const e = (0, o.moveToCellSequence)(
                      t[0] - 1,
                      t[1] - 1,
                      this._bufferService,
              ...
              i
                ? e &&
                  ...
                  ((this._oldSelectionStart &&
                    ...
                    this._fireOnSelectionChange(e, t, i))
            ...
            _getWordAt(e, t, i = !0, s = !0) {
              ...
              if (' ' === o.charAt(a)) {
                ...
                for (
                  s > 1 && ((u += s - 1), (h += s - 1));
                  t > 0 && a > 0 && !this._isCharWordSeparator(n.loadCell(t - 1, this._workCell));
                ) {
                ...
                for (
                  ...
                  i < n.length &&
                  h + 1 < o.length &&
                  !this._isCharWordSeparator(n.loadCell(i + 1, this._workCell));
                ) {
              ...
              if (t) {
                ...
                if (!this._model.areSelectionValuesReversed())
                  for (; t.start + t.length > this._bufferService.cols;)
                    ((t.length -= this._bufferService.cols), i++);
                this._model.selectionEnd = [
          ...
          (Object.defineProperty(t, '__esModule', { value: !0 }),
            (t.IThemeService =
              ...
              t.ICharSizeService =
                void 0));
          const s = i(8343);
          ((t.ICharSizeService = (0, s.createDecorator)('CharSizeService')),
            (t.ICoreBrowserService = (0, s.createDecorator)('CoreBrowserService')),
            (t.IMouseService = (0, s.createDecorator)('MouseService')),
            (t.IRenderService = (0, s.createDecorator)('RenderService')),
            (t.ISelectionService = (0, s.createDecorator)('SelectionService')),
            (t.ICharacterJoinerService = (0, s.createDecorator)('CharacterJoinerService')),
            ...
            (() => {
              ...
              for (let i = 0; i < 216; i++) {
                const s = t[((i / 36) % 6) | 0],
                  r = t[((i / 6) % 6) | 0],
                  n = t[i % 6];
                e.push({ css: o.channels.toCss(s, r, n), rgba: o.channels.toRgba(s, r, n) });
              }
              for (let t = 0; t < 24; t++) {
                const i = 8 + 10 * t;
                e.push({ css: o.channels.toCss(i, i, i), rgba: o.channels.toRgba(i, i, i) });
              }
              return e;
            })()
          );
          let v = (t.ThemeService = class extends h.Disposable {
            ...
            constructor(e) {
              (super(),
                ...
                (this._onChangeColors = this.register(new a.EventEmitter())),
            ...
            _setTheme(e = {}) {
              ...
              if (
                ((i.foreground = p(e.foreground, l)),
                (i.background = p(e.background, d)),
                (i.cursor = p(e.cursor, _)),
                (i.cursorAccent = p(e.cursorAccent, u)),
                (i.selectionBackgroundTransparent = p(e.selectionBackground, f)),
                (i.selectionBackgroundOpaque = o.color.blend(
                  i.background,
                  i.selectionBackgroundTransparent
                )),
                (i.selectionInactiveBackgroundTransparent = p(
                  e.selectionInactiveBackground,
                  i.selectionBackgroundTransparent
                )),
                (i.selectionInactiveBackgroundOpaque = o.color.blend(
                  i.background,
                  i.selectionInactiveBackgroundTransparent
                )),
                (i.selectionForeground = e.selectionForeground
                  ? p(e.selectionForeground, o.NULL_COLOR)
                  : void 0),
                i.selectionForeground === o.NULL_COLOR && (i.selectionForeground = void 0),
                o.color.isOpaque(i.selectionBackgroundTransparent))
              ) {
                const e = 0.3;
                i.selectionBackgroundTransparent = o.color.opacity(
                  i.selectionBackgroundTransparent,
                  e
                );
              }
              if (o.color.isOpaque(i.selectionInactiveBackgroundTransparent)) {
                const e = 0.3;
                i.selectionInactiveBackgroundTransparent = o.color.opacity(
                  i.selectionInactiveBackgroundTransparent,
                  e
                );
              }
              if (
                ...
                (i.ansi[0] = p(e.black, t.DEFAULT_ANSI_COLORS[0])),
                (i.ansi[1] = p(e.red, t.DEFAULT_ANSI_COLORS[1])),
                (i.ansi[2] = p(e.green, t.DEFAULT_ANSI_COLORS[2])),
                (i.ansi[3] = p(e.yellow, t.DEFAULT_ANSI_COLORS[3])),
                (i.ansi[4] = p(e.blue, t.DEFAULT_ANSI_COLORS[4])),
                (i.ansi[5] = p(e.magenta, t.DEFAULT_ANSI_COLORS[5])),
                (i.ansi[6] = p(e.cyan, t.DEFAULT_ANSI_COLORS[6])),
                (i.ansi[7] = p(e.white, t.DEFAULT_ANSI_COLORS[7])),
                (i.ansi[8] = p(e.brightBlack, t.DEFAULT_ANSI_COLORS[8])),
                (i.ansi[9] = p(e.brightRed, t.DEFAULT_ANSI_COLORS[9])),
                (i.ansi[10] = p(e.brightGreen, t.DEFAULT_ANSI_COLORS[10])),
                (i.ansi[11] = p(e.brightYellow, t.DEFAULT_ANSI_COLORS[11])),
                (i.ansi[12] = p(e.brightBlue, t.DEFAULT_ANSI_COLORS[12])),
                (i.ansi[13] = p(e.brightMagenta, t.DEFAULT_ANSI_COLORS[13])),
                (i.ansi[14] = p(e.brightCyan, t.DEFAULT_ANSI_COLORS[14])),
                (i.ansi[15] = p(e.brightWhite, t.DEFAULT_ANSI_COLORS[15])),
                e.extendedAnsi)
              ) {
                const s = Math.min(i.ansi.length - 16, e.extendedAnsi.length);
                for (let r = 0; r < s; r++)
                  i.ansi[r + 16] = p(e.extendedAnsi[r], t.DEFAULT_ANSI_COLORS[r + 16]);
              }
              (this._contrastCache.clear(),
        ...
        6349: (e, t, i) => {
          ...
          class n extends r.Disposable {
            constructor(e) {
              (super(),
                (this._maxLength = e),
                (this.onDeleteEmitter = this.register(new s.EventEmitter())),
                (this.onDelete = this.onDeleteEmitter.event),
                (this.onInsertEmitter = this.register(new s.EventEmitter())),
                (this.onInsert = this.onInsertEmitter.event),
                (this.onTrimEmitter = this.register(new s.EventEmitter())),
            ...
            set maxLength(e) {
              ...
              const t = new Array(e);
              for (let i = 0; i < Math.min(e, this.length); i++)
            ...
            splice(e, t, ...i) {
              if (t) {
                for (let i = e; i < this._length - t; i++)
                  this._array[this._getCyclicIndex(i)] = this._array[this._getCyclicIndex(i + t)];
                ((this._length -= t), this.onDeleteEmitter.fire({ index: e, amount: t }));
              }
              for (let t = this._length - 1; t >= e; t--)
                this._array[this._getCyclicIndex(t + i.length)] =
                  this._array[this._getCyclicIndex(t)];
              for (let t = 0; t < i.length; t++) this._array[this._getCyclicIndex(e + t)] = i[t];
              if (
                (i.length && this.onInsertEmitter.fire({ index: e, amount: i.length }),
          ...
          ((t.NULL_COLOR = { css: '#00000000', rgba: 0 }),
            ...
            (function (e) {
              ...
              ((e.blend = function (e, t) {
                ...
                (e.opaque = function (e) {
                  ...
                  return (([r, n, o] = _.toChannels(t)), { css: h.toCss(r, n, o), rgba: t });
                }),
                (e.opacity = t),
            ...
            (function (e) {
              ...
              e.toColor = function (e) {
                ...
                if (((t.fillStyle = i), (t.fillStyle = e), 'string' != typeof t.fillStyle))
            ...
            (function (e) {
              ...
              ((e.ensureContrastRatio = function (e, s, r) {
                ...
                (e.toColor = function (e, t, i, s) {
                  return { css: h.toCss(e, t, i, s), rgba: h.toRgba(e, t, i, s) };
                }));
            })(_ || (t.rgba = _ = {})),
            (t.toPaddedHex = u),
            (t.contrastRatio = f));
        ...
        8969: (e, t, i) => {
          ...
          class S extends s.Disposable {
            ...
            constructor(e) {
              (super(),
                (this._windowsWrappingHeuristics = this.register(new s.MutableDisposable())),
                (this._onBinary = this.register(new l.EventEmitter())),
                (this.onBinary = this._onBinary.event),
                (this._onData = this.register(new l.EventEmitter())),
                (this.onData = this._onData.event),
                (this._onLineFeed = this.register(new l.EventEmitter())),
                ...
                (this._instantiationService = new n.InstantiationService()),
                (this.optionsService = this.register(new h.OptionsService(e))),
                this._instantiationService.setService(r.IOptionsService, this.optionsService),
                (this._bufferService = this.register(
                  this._instantiationService.createInstance(a.BufferService)
                )),
                this._instantiationService.setService(r.IBufferService, this._bufferService),
                (this._logService = this.register(
                  this._instantiationService.createInstance(o.LogService)
                )),
                this._instantiationService.setService(r.ILogService, this._logService),
                (this.coreService = this.register(
                  this._instantiationService.createInstance(c.CoreService)
                )),
                this._instantiationService.setService(r.ICoreService, this.coreService),
                (this.coreMouseService = this.register(
                  this._instantiationService.createInstance(d.CoreMouseService)
                )),
                this._instantiationService.setService(r.ICoreMouseService, this.coreMouseService),
                (this.unicodeService = this.register(
                  this._instantiationService.createInstance(_.UnicodeService)
                )),
                this._instantiationService.setService(r.IUnicodeService, this.unicodeService),
                (this._charsetService = this._instantiationService.createInstance(
                  u.CharsetService
                )),
                this._instantiationService.setService(r.ICharsetService, this._charsetService),
                (this._oscLinkService = this._instantiationService.createInstance(
                  g.OscLinkService
                )),
                this._instantiationService.setService(r.IOscLinkService, this._oscLinkService),
                ...
                this.register((0, l.forwardEvent)(this._inputHandler.onLineFeed, this._onLineFeed)),
                this.register(this._inputHandler),
                this.register((0, l.forwardEvent)(this._bufferService.onResize, this._onResize)),
                this.register((0, l.forwardEvent)(this.coreService.onData, this._onData)),
                this.register((0, l.forwardEvent)(this.coreService.onBinary, this._onBinary)),
                this.register(
                ...
                (this._writeBuffer = this.register(
                  new p.WriteBuffer((e, t) => this._inputHandler.parse(e, t))
                )),
                this.register(
                  (0, l.forwardEvent)(this._writeBuffer.onWriteParsed, this._onWriteParsed)
                ));
            }
            write(e, t) {
            ...
            resize(e, t) {
              isNaN(e) ||
                isNaN(t) ||
                ((e = Math.max(e, a.MINIMUM_COLS)),
                (t = Math.max(t, a.MINIMUM_ROWS)),
            ...
            _enableWindowsWrappingHeuristics() {
              if (!this._windowsWrappingHeuristics.value) {
                const e = [];
                (e.push(
                  this.onLineFeed(f.updateWindowsModeWrappedState.bind(null, this._bufferService))
                ),
                  e.push(
                    this.registerCsiHandler(
                      { final: 'H' },
                      () => ((0, f.updateWindowsModeWrappedState)(this._bufferService), !1)
                    )
                  ),
                  (this._windowsWrappingHeuristics.value = (0, s.toDisposable)(() => {
          ...
          class E extends h.Disposable {
            ...
            constructor(e, t, i, s, r, h, _, f, v = new a.EscapeSequenceParser()) {
              (super(),
                ...
                (this._oscLinkService = h),
                (this._coreMouseService = _),
                ...
                (this._eraseAttrDataInternal = l.DEFAULT_ATTR_DATA.clone()),
                (this._onRequestBell = this.register(new d.EventEmitter())),
                (this.onRequestBell = this._onRequestBell.event),
                (this._onRequestRefreshRows = this.register(new d.EventEmitter())),
                (this.onRequestRefreshRows = this._onRequestRefreshRows.event),
                (this._onRequestReset = this.register(new d.EventEmitter())),
                (this.onRequestReset = this._onRequestReset.event),
                (this._onRequestSendFocus = this.register(new d.EventEmitter())),
                (this.onRequestSendFocus = this._onRequestSendFocus.event),
                (this._onRequestSyncScrollBar = this.register(new d.EventEmitter())),
                (this.onRequestSyncScrollBar = this._onRequestSyncScrollBar.event),
                (this._onRequestWindowsOptionsReport = this.register(new d.EventEmitter())),
                ...
                this._parser.setPrintHandler((e, t, i) => this.print(e, t, i)),
                ...
                this._parser.setExecuteHandler(n.C0.BEL, () => this.bell()),
                this._parser.setExecuteHandler(n.C0.LF, () => this.lineFeed()),
                this._parser.setExecuteHandler(n.C0.VT, () => this.lineFeed()),
                this._parser.setExecuteHandler(n.C0.FF, () => this.lineFeed()),
                this._parser.setExecuteHandler(n.C0.CR, () => this.carriageReturn()),
                this._parser.setExecuteHandler(n.C0.BS, () => this.backspace()),
                this._parser.setExecuteHandler(n.C0.HT, () => this.tab()),
                this._parser.setExecuteHandler(n.C0.SO, () => this.shiftOut()),
                this._parser.setExecuteHandler(n.C0.SI, () => this.shiftIn()),
                this._parser.setExecuteHandler(n.C1.IND, () => this.index()),
                this._parser.setExecuteHandler(n.C1.NEL, () => this.nextLine()),
                this._parser.setExecuteHandler(n.C1.HTS, () => this.tabSet()),
                this._parser.registerOscHandler(
                  0,
                  new p.OscHandler((e) => (this.setTitle(e), this.setIconName(e), !0))
                ),
                this._parser.registerOscHandler(1, new p.OscHandler((e) => this.setIconName(e))),
                this._parser.registerOscHandler(2, new p.OscHandler((e) => this.setTitle(e))),
                this._parser.registerOscHandler(
                  4,
                  new p.OscHandler((e) => this.setOrReportIndexedColor(e))
                ),
                this._parser.registerOscHandler(8, new p.OscHandler((e) => this.setHyperlink(e))),
                this._parser.registerOscHandler(
                  10,
            ...
            _preserveStack(e, t, i, s) {
              ((this._parseStack.paused = !0),
                ...
                (this._parseStack.decodedLength = i),
                (this._parseStack.position = s));
            }
            ...
            parse(e, t) {
              ...
              if (o) {
                if ((i = this._parser.parse(this._parseBuffer, this._parseStack.decodedLength, t)))
                  return (this._logSlowResolvingAsync(i), i);
              ...
              if (
                (this._logService.logLevel <= v.LogLevelEnum.DEBUG &&
                  this._logService.debug(
                    ...
                    'string' == typeof e ? e.split('').map((e) => e.charCodeAt(0)) : e
                  ),
                ...
                for (let t = n; t < e.length; t += C) {
                  ...
                  if ((i = this._parser.parse(this._parseBuffer, o)))
                    return (this._preserveStack(s, r, o, t), this._logSlowResolvingAsync(i), i);
                }
              else if (!o) {
                const t =
                  'string' == typeof e
                ...
                if ((i = this._parser.parse(this._parseBuffer, t)))
                  return (this._preserveStack(s, r, t, 0), this._logSlowResolvingAsync(i), i);
              }
            ...
            print(e, t, i) {
              ...
              (this._dirtyRowTracker.markDirty(this._activeBuffer.y),
                this._activeBuffer.x &&
                  ...
                  u.setCellFromCodePoint(this._activeBuffer.x - 1, 0, 1, d.fg, d.bg, d.extended));
              for (let f = t; f < i; ++f) {
                ...
                if (
                  ...
                  if (
                    (l &&
                      (u.insertCells(this._activeBuffer.x, r, this._activeBuffer.getNullCell(d), d),
                      2 === u.getWidth(a - 1) &&
                        u.setCellFromCodePoint(
                          a - 1,
                          _.NULL_CELL_CODE,
                    ...
                    u.setCellFromCodePoint(this._activeBuffer.x++, s, r, d.fg, d.bg, d.extended),
                    r > 0)
                  )
                    for (; --r;)
                      u.setCellFromCodePoint(this._activeBuffer.x++, 0, 0, d.fg, d.bg, d.extended);
                } else
              ...
              (i - t > 0 &&
                ...
                2 === this._workCell.getWidth() || this._workCell.getCode() > 65535
                ...
                this._activeBuffer.x < a &&
                  ...
                  u.setCellFromCodePoint(this._activeBuffer.x, 0, 1, d.fg, d.bg, d.extended),
                this._dirtyRowTracker.markDirty(this._activeBuffer.y));
            }
            registerCsiHandler(e, t) {
              return 't' !== e.final || e.prefix || e.intermediates
                ...
                : this._parser.registerCsiHandler(
                    e,
                    (e) => !b(e.params[0], this._optionsService.rawOptions.windowOptions) || t(e)
                  );
            }
            registerDcsHandler(e, t) {
            ...
            _resetBufferLine(e, t = !1) {
              ...
              i &&
                (i.fill(this._activeBuffer.getNullCell(this._eraseAttrData()), t),
              ...
              switch ((this._restrictCursor(this._bufferService.cols), e.params[0])) {
                ...
                case 1:
                  for (
                    i = this._activeBuffer.y,
                      this._dirtyRowTracker.markDirty(i),
                      this._eraseInBufferLine(i, 0, this._activeBuffer.x + 1, !0, t),
                      this._activeBuffer.x + 1 >= this._bufferService.cols &&
                        (this._activeBuffer.lines.get(i + 1).isWrapped = !1);
                    i--;
                  )
                    this._resetBufferLine(i, t);
                  ...
                  break;
                case 2:
                  for (i = this._bufferService.rows, this._dirtyRowTracker.markDirty(i - 1); i--;)
                    this._resetBufferLine(i, t);
                  this._dirtyRowTracker.markDirty(0);
                  break;
                case 3:
            ...
            insertLines(e) {
              ...
              for (; t--;)
                (this._activeBuffer.lines.splice(r - 1, 1),
            ...
            deleteLines(e) {
              ...
              for (
                s = this._bufferService.rows - 1 - this._activeBuffer.scrollBottom,
                  s = this._bufferService.rows - 1 + this._activeBuffer.ybase - s;
                t--;
              )
              ...
              return (
                e.params[0] > 0 ||
                  (this._is('xterm') || this._is('rxvt-unicode') || this._is('screen')
                    ? this._coreService.triggerDataEvent(n.C0.ESC + '[?1;2c')
                    : this._is('linux') && this._coreService.triggerDataEvent(n.C0.ESC + '[?6c')),
                !0
              );
            }
            sendDeviceAttributesSecondary(e) {
              return (
                e.params[0] > 0 ||
                  (this._is('xterm')
                    ? this._coreService.triggerDataEvent(n.C0.ESC + '[>0;276;0c')
                    : this._is('rxvt-unicode')
                      ? this._coreService.triggerDataEvent(n.C0.ESC + '[>85;95;0c')
                      : this._is('linux')
                        ? this._coreService.triggerDataEvent(e.params[0] + 'c')
                        : this._is('screen') &&
                          this._coreService.triggerDataEvent(n.C0.ESC + '[>83;40003;0c')),
                !0
              );
            }
            _is(e) {
                ...
                switch (e.params[t]) {
                  ...
                  case 2:
                    (this._charsetService.setgCharset(0, o.DEFAULT_CHARSET),
                      this._charsetService.setgCharset(1, o.DEFAULT_CHARSET),
                      this._charsetService.setgCharset(2, o.DEFAULT_CHARSET),
                      this._charsetService.setgCharset(3, o.DEFAULT_CHARSET));
                    break;
                  case 3:
            ...
            requestMode(e, t) {
              const i = this._coreService.decPrivateModes,
                { activeProtocol: s, activeEncoding: r } = this._coreMouseService,
                o = this._coreService,
                { buffers: a, cols: h } = this._bufferService,
                { active: c, alt: l } = a,
                            ...
                            : 9 === u
                              ...
                              : 12 === u
                                ...
                                : 25 === u
                                  ? _(!o.isCursorHidden)
                                  : 45 === u
                                    ? _(i.reverseWraparound)
                                    : 66 === u
                                      ? _(i.applicationKeypad)
                                      : 67 === u
                                        ? 4
                                        : 1e3 === u
                                          ? _('VT200' === s)
            ...
            _updateAttrColor(e, t, i, s, r) {
              return (
                2 === t
                  ? ((e |= 50331648),
                    (e &= -16777216),
                    (e |= f.AttributeData.fromColorRGB([i, s, r])))
                  : 5 === t && ((e &= -50331904), (e |= 33554432 | (255 & i))),
                e
              );
            }
            _extractColor(e, t, i) {
              ...
              switch (s[0]) {
                ...
                case 58:
                  ((i.extended = i.extended.clone()),
                    (i.extended.underlineColor = this._updateAttrColor(
                      i.extended.underlineColor,
                      s[1],
                      s[3],
                      s[4],
                      s[5]
            ...
            _processSGR0(e) {
              ((e.fg = l.DEFAULT_ATTR_DATA.fg),
                (e.bg = l.DEFAULT_ATTR_DATA.bg),
            ...
            charAttributes(e) {
              ...
              for (let r = 0; r < t; r++)
                ((i = e.params[r]),
                  i >= 30 && i <= 37
                    ? ((s.fg &= -50331904), (s.fg |= 16777216 | (i - 30)))
                    : i >= 40 && i <= 47
                      ? ((s.bg &= -50331904), (s.bg |= 16777216 | (i - 40)))
                      : i >= 90 && i <= 97
                        ? ((s.fg &= -50331904), (s.fg |= 16777224 | (i - 90)))
                        : i >= 100 && i <= 107
                          ? ((s.bg &= -50331904), (s.bg |= 16777224 | (i - 100)))
                          : 0 === i
                            ? this._processSGR0(s)
                            : 1 === i
                              ? (s.fg |= 134217728)
                                ...
                                : 4 === i
                                  ? ((s.fg |= 268435456),
                                    this._processUnderline(
                                      e.hasSubParams(r) ? e.getSubParams(r)[0] : 1,
                                      s
                                    ))
                                  : 5 === i
                                    ? (s.fg |= 536870912)
                                      ...
                                      : 8 === i
                                        ...
                                        : 9 === i
                                          ...
                                          : 2 === i
                                            ? (s.bg |= 134217728)
                                            : 21 === i
                                              ? this._processUnderline(2, s)
                                              : 22 === i
                                                ? ((s.fg &= -134217729), (s.bg &= -134217729))
                                                : 23 === i
                                                  ? (s.bg &= -67108865)
                                                  : 24 === i
                                                    ? ((s.fg &= -268435457),
                                                      this._processUnderline(0, s))
                                                    : 25 === i
                                                      ? (s.fg &= -536870913)
                                                      : 27 === i
                                                        ? (s.fg &= -67108865)
                                                          ...
                                                          : 29 === i
                                                            ...
                                                            : 39 === i
                                                              ? ((s.fg &= -67108864),
                                                                (s.fg |=
                                                                  16777215 &
                                                                  l.DEFAULT_ATTR_DATA.fg))
                                                              : 49 === i
                                                                ? ((s.bg &= -67108864),
                                                                  (s.bg |=
                                                                    16777215 &
                                                                    l.DEFAULT_ATTR_DATA.bg))
                                                                : 38 === i || 48 === i || 58 === i
                                                                  ? (r += this._extractColor(
                                                                      e,
                                                                      r,
                                                                      s
                                                                    ))
            ...
            setScrollRegion(e) {
              ...
              let i;
              return (
                (e.length < 2 || (i = e.params[1]) > this._bufferService.rows || 0 === i) &&
                  (i = this._bufferService.rows),
                i > t &&
                  ((this._activeBuffer.scrollTop = t - 1),
                  (this._activeBuffer.scrollBottom = i - 1),
                  this._setCursor(0, 0)),
                !0
              );
            }
            ...
            setHyperlink(e) {
              ...
              return (
                !(t.length < 2) &&
                (t[1] ? this._createHyperlink(t[0], t[1]) : !t[0] && this._finishHyperlink())
              );
            }
            ...
            _setOrReportSpecialColor(e, t) {
              ...
              for (let e = 0; e < i.length && !(t >= this._specialColors.length); ++e, ++t)
                if ('?' === i[e]) this._onColor.fire([{ type: 0, index: this._specialColors[t] }]);
                else {
            ...
            requestStatusString(e, t) {
              ...
              return ((e) => (
                this._coreService.triggerDataEvent(`${n.C0.ESC}${e}${n.C0.ESC}\\`),
                !0
              ))(
                '"q' === e
                  ...
                  : '"p' === e
                    ? 'P1$r61;1"p'
                    : 'r' === e
                      ? `P1$r${i.scrollTop + 1};${i.scrollBottom + 1}r`
                      : 'm' === e
                        ? 'P1$r0m'
                        : ' q' === e
                          ? `P1$r${{ block: 2, underline: 4, bar: 6 }[s.cursorStyle] - (s.cursorBlink ? 1 : 0)} q`
                          : 'P0$r'
              );
            }
            markRangeDirty(e, t) {
          ...
          t.SortedList = class {
            ...
            insert(e) {
              0 !== this._array.length
                ? ((i = this._search(this._getKey(e))), this._array.splice(i, 0, e))
                : this._array.push(e);
            }
            delete(e) {
            ...
            *getKeyIterator(e) {
              if (
                0 !== this._array.length &&
                ((i = this._search(e)),
                !(i < 0 || i >= this._array.length) && this._getKey(this._array[i]) === e)
              )
                do {
                  yield this._array[i];
              ...
              for (; this._i < this._tasks.length;) {
                if (
                  ...
                  return (
                    s - t < -20 &&
                      console.warn(
                        `task queue exceeded allotted deadline by ${Math.abs(Math.round(s - t))}ms`
                      ),
                    void this._start()
                  );
                s = r;
        ...
        9282: (e, t, i) => {
          ...
          t.updateWindowsModeWrappedState = function (e) {
            ...
            r &&
              i &&
              (r.isWrapped =
                i[s.CHAR_DATA_CODE_INDEX] !== s.NULL_CELL_CODE &&
                i[s.CHAR_DATA_CODE_INDEX] !== s.WHITESPACE_CELL_CODE);
          };
        },
        3734: (e, t) => {
          (Object.defineProperty(t, '__esModule', { value: !0 }),
          ...
          class i {
            ...
            isUnderline() {
              return this.hasExtendedAttrs() && 0 !== this.extended.underlineStyle
                ? 1
                : 268435456 & this.fg;
            }
            isBlink() {
            ...
            (t.Buffer = class {
              constructor(e, t, i) {
                ((this._hasScrollback = e),
                  ...
                  (this.lines = new s.CircularList(this._getCorrectBufferLength(this._rows))),
                  (this.scrollTop = 0),
              ...
              getNullCell(e) {
                return (
                  e
                    ...
                    : ((this._nullCell.fg = 0),
                      (this._nullCell.bg = 0),
                      (this._nullCell.extended = new n.ExtendedAttrs())),
                  this._nullCell
                );
              }
              getWhitespaceCell(e) {
                return (
                  e
                    ...
                    : ((this._whitespaceCell.fg = 0),
                      ...
                      (this._whitespaceCell.extended = new n.ExtendedAttrs())),
              ...
              resize(e, t) {
                ...
                if (
                  (r > this.lines.maxLength && (this.lines.maxLength = r), this.lines.length > 0)
                ) {
                  if (this._cols < e)
                    for (let t = 0; t < this.lines.length; t++)
                      s += +this.lines.get(t).resize(e, i);
                  let n = 0;
                  if (this._rows < t)
                    for (let s = this._rows; s < t; s++)
                      this.lines.length < t + this.ybase &&
                        (this._optionsService.rawOptions.windowsMode ||
                        void 0 !== this._optionsService.rawOptions.windowsPty.backend ||
                        void 0 !== this._optionsService.rawOptions.windowsPty.buildNumber
                          ? this.lines.push(new o.BufferLine(e, i))
                          : this.ybase > 0 && this.lines.length <= this.ybase + this.y + n + 1
                            ? (this.ybase--, n++, this.ydisp > 0 && this.ydisp--)
                            : this.lines.push(new o.BufferLine(e, i)));
                  else
              ...
              _batchedMemoryCleanup() {
                ...
                for (; this._memoryCleanupPosition < this.lines.length;)
                  if (
                    ((t += this.lines.get(this._memoryCleanupPosition++).cleanupMemory()), t > 100)
                  )
                    return !0;
                return e;
              }
              get _isReflowEnabled() {
                ...
                return e && e.buildNumber
                  ? this._hasScrollback && 'conpty' === e.backend && e.buildNumber >= 21376
              ...
              _reflowLarger(e, t) {
                const i = (0, a.reflowLargerGetLinesToRemove)(
                  this.lines,
                  this._cols,
                  e,
                  this.ybase + this.y,
                ...
                if (i.length > 0) {
                  ...
                  ((0, a.reflowLargerApplyNewLayout)(this.lines, s.layout),
                    this._reflowLargerAdjustViewport(e, t, s.countRemoved));
                }
              }
              _reflowLargerAdjustViewport(e, t, i) {
                ...
                for (; r-- > 0;)
                  0 === this.ybase
                    ? (this.y > 0 && this.y--,
                      this.lines.length < t && this.lines.push(new o.BufferLine(e, s)))
                ...
                for (let n = this.lines.length - 1; n >= 0; n--) {
                  ...
                  f =
                    0 === this.ybase && this.y !== this.lines.length - 1
                      ...
                      : Math.max(0, this.lines.length - this.lines.maxLength + u);
                  const v = [];
                  for (let e = 0; e < u; e++) {
                  ...
                  (v.length > 0 &&
                    (s.push({ start: n + c.length + r, newLines: v }), (r += v.length)),
                    c.push(...v));
                  let p = _.length - 1,
                    g = _[p];
                  0 === g && (p--, (g = _[p]));
                  ...
                  for (; m >= 0;) {
                    ...
                    if (void 0 === c[p]) break;
                    if (
                      (c[p].copyCellsFrom(c[m], S - e, g - e, e, !0),
                      (g -= e),
                      0 === g && (p--, (g = _[p])),
                      (S -= e),
                      0 === S)
                  ...
                  for (; C-- > 0;)
                    0 === this.ybase
                      ? this.y < t - 1
                        ...
                        : (this.ybase++, this.ydisp++)
                      : this.ybase < Math.min(this.lines.maxLength, this.lines.length + r) - t &&
                ...
                if (s.length > 0) {
                  ...
                  for (let c = Math.min(this.lines.maxLength - 1, i + r - 1); c >= 0; c--)
                    if (a && a.start > n + h) {
                      ...
                      (c++,
                        e.push({ index: n + 1, amount: a.newLines.length }),
                        (h += a.newLines.length),
                        (a = s[++o]));
              ...
              setupTabStops(e) {
                for (
                  null != e ? this.tabs[e] || (e = this.prevStop(e)) : ((this.tabs = {}), (e = 0));
                  e < this._cols;
        ...
        8437: (e, t, i) => {
          ...
          class h {
            constructor(e, t, i = !1) {
              ...
              const s =
                t ||
                r.CellData.fromCharData([0, n.NULL_CELL_CHAR, n.NULL_CELL_WIDTH, n.NULL_CELL_CODE]);
              ...
              ((this._data[3 * e + 1] = t[n.CHAR_DATA_ATTR_INDEX]),
                t[n.CHAR_DATA_CHAR_INDEX].length > 1
                  ? ((this._combined[e] = t[1]),
                    (this._data[3 * e + 0] = 2097152 | e | (t[n.CHAR_DATA_WIDTH_INDEX] << 22)))
                  : (this._data[3 * e + 0] =
            ...
            addCodepointToCell(e, t) {
              ...
              2097152 & i
                ...
                : (2097151 & i
                    ? ((this._combined[e] =
                        (0, o.stringFromCodePoint)(2097151 & i) + (0, o.stringFromCodePoint)(t)),
                      (i &= -2097152),
                      (i |= 2097152))
                    : (i = t | (1 << 22)),
                  (this._data[3 * e + 0] = i));
            ...
            insertCells(e, t, i, n) {
              if (
                ...
                for (let i = this.length - e - t - 1; i >= 0; --i)
                  this.setCell(e + t + i, this.loadCell(e + i, s));
            ...
            deleteCells(e, t, i, n) {
              if (((e %= this.length), t < this.length - e)) {
                ...
                for (let i = 0; i < this.length - e - t; ++i)
                  this.setCell(e + i, this.loadCell(e + t + i, s));
            ...
            replaceCells(e, t, i, r, n = !1) {
              if (n)
                for (
                  ...
                  (this.isProtected(e) || this.setCell(e, i), e++);
              else
                for (
                  e &&
                    2 === this.getWidth(e - 1) &&
            ...
            resize(e, t) {
              ...
              const i = 3 * e;
              if (e > this.length) {
                if (this._data.buffer.byteLength >= 4 * i)
            ...
            copyCellsFrom(e, t, i, s, r) {
              ...
              if (r)
                for (let r = s - 1; r >= 0; r--) {
                  ...
                  268435456 & n[3 * (t + r) + 2] &&
                    (this._extendedAttrs[i + r] = e._extendedAttrs[t + r]);
                }
              else
                for (let r = 0; r < s; r++) {
                  for (let e = 0; e < 3; e++) this._data[3 * (i + r) + e] = n[3 * (t + r) + e];
          ...
          (Object.defineProperty(t, '__esModule', { value: !0 }),
            (t.getWrappedLineTrimmedLength =
              ...
              t.reflowLargerGetLinesToRemove =
                void 0),
            (t.reflowLargerGetLinesToRemove = function (e, t, s, r, n) {
              const o = [];
              for (let a = 0; a < e.length - 1; a++) {
                ...
                for (; u < l.length;) {
                  ...
                  (l[d].copyCellsFrom(l[u], f, _, a, !1),
                    ...
                    0 === _ &&
                      0 !== d &&
                      2 === l[d - 1].getWidth(s - 1) &&
                      (l[d].copyCellsFrom(l[d - 1], s - 1, _++, 1, !1),
                      l[d - 1].setCell(s - 1, n)));
                }
                l[d].replaceCells(_, s, n);
                let v = 0;
                for (let e = l.length - 1; e > 0 && (e > d || 0 === l[e].getTrimmedLength()); e--)
                  v++;
            ...
            (t.reflowLargerCreateNewLayout = function (e, t) {
              ...
              for (let o = 0; o < e.length; o++)
                if (r === o) {
                  const i = t[++s];
                  (e.onDeleteEmitter.fire({ index: o - n, amount: i }),
                    (o += i - 1),
                    (n += i),
                    (r = t[++s]));
                } else i.push(o);
          ...
          class o extends r.Disposable {
            constructor(e, t) {
              (super(),
                (this._optionsService = e),
                (this._bufferService = t),
                (this._onBufferActivate = this.register(new s.EventEmitter())),
            ...
            reset() {
              ((this._normal = new n.Buffer(!0, this._optionsService, this._bufferService)),
                this._normal.fillViewportRows(),
                (this._alt = new n.Buffer(!1, this._optionsService, this._bufferService)),
                ...
                if (55296 <= i && i <= 56319) {
                  ...
                  56320 <= s && s <= 57343
                    ? (this.content =
                        ...
                        (e[r.CHAR_DATA_WIDTH_INDEX] << 22))
                    : (t = !0);
                } else t = !0;
              } else
                this.content =
                  e[r.CHAR_DATA_CHAR_INDEX].charCodeAt(0) | (e[r.CHAR_DATA_WIDTH_INDEX] << 22);
              t &&
                ((this.combinedData = e[r.CHAR_DATA_CHAR_INDEX]),
            ...
            switch (e.keyCode) {
              case 0:
                'UIKeyInputUpArrow' === e.key
                  ? (o.key = t ? s.C0.ESC + 'OA' : s.C0.ESC + '[A')
                  : 'UIKeyInputLeftArrow' === e.key
                    ? (o.key = t ? s.C0.ESC + 'OD' : s.C0.ESC + '[D')
                    : 'UIKeyInputRightArrow' === e.key
                      ? (o.key = t ? s.C0.ESC + 'OC' : s.C0.ESC + '[C')
              ...
              case 37:
                if (e.metaKey) break;
                a
                  ? ((o.key = s.C0.ESC + '[1;' + (a + 1) + 'D'),
                    o.key === s.C0.ESC + '[1;3D' && (o.key = s.C0.ESC + (i ? 'b' : '[1;5D')))
                  : (o.key = t ? s.C0.ESC + 'OD' : s.C0.ESC + '[D');
                break;
              case 39:
                if (e.metaKey) break;
                a
                  ? ((o.key = s.C0.ESC + '[1;' + (a + 1) + 'C'),
                    o.key === s.C0.ESC + '[1;3C' && (o.key = s.C0.ESC + (i ? 'f' : '[1;5C')))
                  : (o.key = t ? s.C0.ESC + 'OC' : s.C0.ESC + '[C');
                break;
              case 38:
                if (e.metaKey) break;
                a
                  ? ((o.key = s.C0.ESC + '[1;' + (a + 1) + 'A'),
                    i || o.key !== s.C0.ESC + '[1;3A' || (o.key = s.C0.ESC + '[1;5A'))
                  : (o.key = t ? s.C0.ESC + 'OA' : s.C0.ESC + '[A');
                break;
              case 40:
                if (e.metaKey) break;
                a
                  ? ((o.key = s.C0.ESC + '[1;' + (a + 1) + 'B'),
                    i || o.key !== s.C0.ESC + '[1;3B' || (o.key = s.C0.ESC + '[1;5B'))
                  : (o.key = t ? s.C0.ESC + 'OB' : s.C0.ESC + '[B');
                break;
              case 45:
              ...
              default:
                if (!e.ctrlKey || e.shiftKey || e.altKey || e.metaKey)
                  if ((i && !n) || !e.altKey || e.metaKey)
                    !i || e.altKey || e.ctrlKey || e.shiftKey || !e.metaKey
                      ? e.key &&
                        !e.ctrlKey &&
                        !e.altKey &&
                        !e.metaKey &&
                        ...
                        : e.key &&
                          e.ctrlKey &&
                          ('_' === e.key && (o.key = s.C0.US), '@' === e.key && (o.key = s.C0.NUL))
        ...
        482: (e, t) => {
          (Object.defineProperty(t, '__esModule', { value: !0 }),
            ...
            (t.stringFromCodePoint = function (e) {
              return e > 65535
                ? ((e -= 65536),
                  String.fromCharCode(55296 + (e >> 10)) + String.fromCharCode((e % 1024) + 56320))
              ...
              decode(e, t) {
                ...
                for (let n = r; n < i; ++n) {
                  ...
                  if (55296 <= r && r <= 56319) {
                    ...
                    56320 <= o && o <= 57343
                      ? (t[s++] = 1024 * (r - 55296) + o - 56320 + 65536)
                      : ((t[s++] = r), (t[s++] = o));
                  } else 65279 !== r && (t[s++] = r);
                }
                return s;
            ...
            (t.Utf8ToUtf32 = class {
              ...
              decode(e, t) {
                ...
                if (this.interim[0]) {
                  ...
                  const h =
                      192 == (224 & this.interim[0]) ? 2 : 224 == (240 & this.interim[0]) ? 3 : 4,
                    l = h - o;
                  for (; c < l;) {
                    if (c >= i) return 0;
                    if (((n = e[c++]), 128 != (192 & n))) {
          ...
          class n extends r.Disposable {
            constructor(e) {
              (super(),
                ...
                (this._onWriteParsed = this.register(new s.EventEmitter())),
                (this.onWriteParsed = this._onWriteParsed.event));
            }
            handleUserInput() {
        ...
        5941: (e, t) => {
          ...
          ((t.parseColor = function (e) {
            ...
            if (0 === t.indexOf('rgb:')) {
              ...
              0 === t.indexOf('#') &&
              ((t = t.slice(1)), s.exec(t) && [3, 6, 9, 12].includes(t.length))
            ) {
              const e = t.length / 3,
                i = [0, 0, 0];
              for (let s = 0; s < 3; ++s) {
        ...
        6351: (e, t, i) => {
          ...
          t.DcsParser = class {
            ...
            unhook(e, t = !0) {
              if (this._active.length) {
                ...
                if (
                  (this._stack.paused &&
                    ((s = this._stack.loopPosition - 1),
                    (i = t),
                    (r = this._stack.fallThrough),
                ...
                for (; s >= 0; s--)
                  if (((i = this._active[s].unhook(!1)), i instanceof Promise))
                    return (
                      (this._stack.paused = !0),
                      (this._stack.loopPosition = s),
          ...
          (a.addParam(0),
            (t.DcsHandler = class {
              ...
              hook(e) {
                ((this._params = e.length > 1 || e.params[0] ? e.clone() : a),
                  (this._data = ''),
                  (this._hitLimit = !1));
              }
              put(e, t, i) {
                this._hitLimit ||
                  ((this._data += (0, s.utf32ToString)(e, t, i)),
              ...
              unhook(e) {
                ...
                if (this._hitLimit) t = !1;
                  ...
                  return t.then(
                    (e) => ((this._params = a), (this._data = ''), (this._hitLimit = !1), e)
                  );
        ...
        2015: (e, t, i) => {
          ...
          t.VT500_TRANSITION_TABLE = (function () {
            ...
            const n = i(0, 14);
            let o;
            for (o in (e.setDefault(1, 0), e.addMany(s, 0, 2, 0), n))
              (e.addMany([24, 26, 153, 154], o, 3, 0),
                e.addMany(i(128, 144), o, 3, 0),
                e.addMany(i(144, 152), o, 3, 0),
                e.add(156, o, 0, 0),
                e.add(27, o, 11, 1),
                e.add(157, o, 4, 8),
            ...
            return (
              ...
              e.add(127, 7, 0, 7),
              e.add(91, 1, 11, 3),
              e.addMany(i(64, 127), 3, 7, 0),
              e.addMany(i(48, 60), 3, 8, 4),
              e.addMany([60, 61, 62, 63], 3, 9, 4),
              e.addMany(i(48, 60), 4, 8, 4),
              e.addMany(i(64, 127), 4, 7, 0),
              e.addMany([60, 61, 62, 63], 4, 0, 6),
              e.addMany(i(32, 64), 6, 0, 6),
              e.add(127, 6, 0, 6),
              e.addMany(i(64, 127), 6, 0, 0),
              e.addMany(i(32, 48), 3, 9, 5),
              e.addMany(i(32, 48), 5, 9, 5),
              e.addMany(i(48, 64), 5, 0, 6),
              e.addMany(i(64, 127), 5, 7, 0),
              e.addMany(i(32, 48), 4, 9, 5),
              e.addMany(i(32, 48), 1, 9, 2),
              e.addMany(i(32, 48), 2, 9, 2),
              e.addMany(i(48, 127), 2, 10, 0),
              e.addMany(i(48, 80), 1, 10, 0),
              e.addMany(i(81, 88), 1, 10, 0),
              e.addMany([89, 90, 92], 1, 10, 0),
              e.addMany(i(96, 127), 1, 10, 0),
              e.add(80, 1, 11, 9),
              e.addMany(r, 9, 0, 9),
              e.add(127, 9, 0, 9),
              e.addMany(i(28, 32), 9, 0, 9),
              e.addMany(i(32, 48), 9, 9, 12),
              e.addMany(i(48, 60), 9, 8, 10),
              e.addMany([60, 61, 62, 63], 9, 9, 10),
              e.addMany(r, 11, 0, 11),
              e.addMany(i(32, 128), 11, 0, 11),
              e.addMany(i(28, 32), 11, 0, 11),
              e.addMany(r, 10, 0, 10),
              e.add(127, 10, 0, 10),
              e.addMany(i(28, 32), 10, 0, 10),
              e.addMany(i(48, 60), 10, 8, 10),
              e.addMany([60, 61, 62, 63], 10, 0, 11),
              e.addMany(i(32, 48), 10, 9, 12),
              e.addMany(r, 12, 0, 12),
              e.add(127, 12, 0, 12),
              e.addMany(i(28, 32), 12, 0, 12),
              e.addMany(i(32, 48), 12, 9, 12),
              e.addMany(i(48, 64), 12, 0, 11),
              e.addMany(i(64, 127), 12, 12, 13),
              e.addMany(i(64, 127), 10, 12, 13),
              e.addMany(i(64, 127), 9, 12, 13),
              e.addMany(r, 13, 13, 13),
              e.addMany(s, 13, 13, 13),
              e.add(127, 13, 0, 13),
          ...
          class c extends s.Disposable {
            ...
            _identifier(e, t = [64, 126]) {
              ...
              if (e.prefix) {
                ...
                if (((i = e.prefix.charCodeAt(0)), (i && 60 > i) || i > 63))
            ...
            _preserveStack(e, t, i, s, r) {
              ((this._parseStack.state = e),
                ...
                (this._parseStack.transition = s),
                (this._parseStack.chunkPos = r));
            }
            parse(e, t, i) {
              let s,
                r = 0,
              ...
              if (this._parseStack.state)
                if (2 === this._parseStack.state)
                  ...
                  if (void 0 === i || 1 === this._parseStack.state)
                    throw (
                  ...
                  switch (this._parseStack.state) {
                    ...
                    case 6:
                      if (
                        ...
                        (s = this._dcsParser.unhook(24 !== r && 26 !== r, i)),
                        s)
                      )
                        return s;
                      (27 === r && (this._parseStack.transition |= 1),
                        this._params.reset(),
                        this._params.addParam(0),
                        (this._collect = 0));
                      break;
                    case 5:
                      if (
                        ((r = e[this._parseStack.chunkPos]),
                        (s = this._oscParser.end(24 !== r && 26 !== r, i)),
                        s)
                      )
                        return s;
                      (27 === r && (this._parseStack.transition |= 1),
              ...
              for (let i = o; i < t; ++i) {
                switch (
                  ((r = e[i]),
                  (n = this._transitions.table[(this.currentState << 8) | (r < 160 ? r : h)]),
                  n >> 4)
                ) {
                  case 2:
                    for (let s = i + 1; ; ++s) {
                  ...
                  case 7:
                    ...
                    (a < 0 && this._csiHandlerFb((this._collect << 8) | r, this._params),
                      (this.precedingCodepoint = 0));
                    break;
                  case 8:
                    do {
                  ...
                  case 13:
                    ...
                    break;
                  case 14:
                    if (((s = this._dcsParser.unhook(24 !== r && 26 !== r)), s))
                      return (this._preserveStack(6, [], 0, n, i), s);
                    (27 === r && (n |= 1),
                      this._params.reset(),
                      this._params.addParam(0),
                      (this._collect = 0),
                  ...
                  case 5:
                    ...
                    break;
                  case 6:
                    if (((s = this._oscParser.end(24 !== r && 26 !== r)), s))
                      return (this._preserveStack(5, [], 0, n, i), s);
                    (27 === r && (n |= 1),
                      this._params.reset(),
                      this._params.addParam(0),
                      (this._collect = 0),
        ...
        6242: (e, t, i) => {
          ...
          ((t.OscParser = class {
              ...
              if (0 !== this._state) {
                if (3 !== this._state)
                  if ((1 === this._state && this._start(), this._active.length)) {
                    ...
                    for (; s >= 0; s--)
                      if (((i = this._active[s].end(!1)), i instanceof Promise))
                        return (
                          (this._stack.paused = !0),
                          (this._stack.loopPosition = s),
                          (this._stack.fallThrough = !0),
            ...
            (t.OscHandler = class {
              ...
              put(e, t, i) {
                this._hitLimit ||
                  ((this._data += (0, r.utf32ToString)(e, t, i)),
                  this._data.length > s.PAYLOAD_LIMIT &&
                    ((this._data = ''), (this._hitLimit = !0)));
              }
              end(e) {
                let t = !1;
            ...
            addParam(e) {
              if (((this._digitIsSub = !1), this.length >= this.maxLength)) this._rejectDigits = !0;
                ...
                ((this._subParamsIdx[this.length] =
                  ...
                  (this.params[this.length++] = e > i ? i : e));
              }
            }
            addSubParam(e) {
              if (((this._digitIsSub = !0), this.length))
                if (this._rejectDigits || this._subParamsLength >= this.maxSubParamsLength)
                  ...
                  if (e < -1) throw new Error('values lesser than -1 are not allowed');
                  ((this._subParams[this._subParamsLength++] = e > i ? i : e),
        ...
        5741: (e, t) => {
          (Object.defineProperty(t, '__esModule', { value: !0 }),
            ...
            (t.AddonManager = class {
              ...
              loadAddon(e, t) {
                const i = { instance: t, dispose: t.dispose, isDisposed: !1 };
                (this._addons.push(i),
                  (t.dispose = () => this._wrappedAddonDispose(i)),
                  t.activate(e));
              }
            ...
            getCell(e, t) {
              if (!(e < 0 || e >= this._line.length))
                return t
                  ...
                  : this._line.loadCell(e, new s.CellData());
            }
        ...
        8285: (e, t, i) => {
          ...
          class o extends n.Disposable {
            constructor(e) {
              (super(),
                (this._core = e),
                (this._onBufferChange = this.register(new r.EventEmitter())),
                (this.onBufferChange = this._onBufferChange.event),
                (this._normal = new s.BufferApiView(this._core.buffers.normal, 'normal')),
                (this._alternate = new s.BufferApiView(this._core.buffers.alt, 'alternate')),
          ...
          let c = (t.BufferService = class extends o.Disposable {
            ...
            constructor(e) {
              (super(),
                ...
                (this.onScroll = this._onScroll.event),
                (this.cols = Math.max(e.rawOptions.cols || 0, t.MINIMUM_COLS)),
                (this.rows = Math.max(e.rawOptions.rows || 0, t.MINIMUM_ROWS)),
                (this.buffers = this.register(new a.BufferSet(e, this))));
            }
            resize(e, t) {
              ((this.cols = e),
                (this.rows = t),
            ...
            scroll(e, t = !1) {
              const i = this.buffer;
              let s;
              ((s = this._cachedBlankLine),
                (s && s.length === this.cols && s.getFg(0) === e.fg && s.getBg(0) === e.bg) ||
                  ((s = i.getBlankLine(e, t)), (this._cachedBlankLine = s)),
                (s.isWrapped = t));
              ...
              if (0 === i.scrollTop) {
                ...
                (n === i.lines.length - 1
                  ? e
                    ? i.lines.recycle().copyFrom(s)
                    : i.lines.push(s.clone())
                  : i.lines.splice(n + 1, 0, s.clone()),
                  e
                    ? this.isUserScrolling && (i.ydisp = Math.max(i.ydisp - 1, 0))
                    : (i.ybase++, this.isUserScrolling || i.ydisp++));
              } else {
                const e = n - r + 1;
            ...
            scrollLines(e, t, i) {
              ...
              const r = s.ydisp;
              ((s.ydisp = Math.max(Math.min(s.ydisp + e, s.ybase), 0)),
                r !== s.ydisp && (t || this._onScroll.fire(s.ydisp)));
            }
          });
        ...
        1753: function (e, t, i) {
          ...
          const n = i(2585),
            ...
            h = {
              ...
              VT200: { events: 19, restrict: (e) => 32 !== e.action },
              DRAG: { events: 23, restrict: (e) => 32 !== e.action || 3 !== e.button },
            ...
            return (
              4 === e.button
                ...
                : ((i |= 3 & e.button),
                  4 & e.button && (i |= 64),
                  8 & e.button && (i |= 128),
                  32 === e.action ? (i |= 32) : 0 !== e.action || t || (i |= 3)),
              i
            );
          }
          ...
          let _ = (t.CoreMouseService = class extends a.Disposable {
            constructor(e, t) {
              (super(),
                ...
                (this._onProtocolChange = this.register(new o.EventEmitter())),
            ...
            triggerMouseEvent(e) {
              ...
              if (
                ...
                32 === e.action &&
                  this._lastEvent &&
                  this._equalEvents(this._lastEvent, e, 'SGR_PIXELS' === this._activeEncoding))
              )
                return !1;
        ...
        6975: function (e, t, i) {
          ...
          let d = (t.CoreService = class extends a.Disposable {
            constructor(e, t, i) {
              (super(),
                ...
                (this.onBinary = this._onBinary.event),
                (this._onRequestScrollToBottom = this.register(new o.EventEmitter())),
          ...
          t.CoreService = d = s(
            [r(0, h.IBufferService), r(1, h.ILogService), r(2, h.IOptionsService)],
            d
          );
        },
        9074: (e, t, i) => {
          ...
          class c extends n.Disposable {
            ...
            constructor() {
              (super(),
                (this._decorations = new o.SortedList((e) => (null == e ? void 0 : e.marker.line))),
                (this._onDecorationRegistered = this.register(new r.EventEmitter())),
                (this.onDecorationRegistered = this._onDecorationRegistered.event),
                (this._onDecorationRemoved = this.register(new r.EventEmitter())),
            ...
            registerDecoration(e) {
              ...
              if (t) {
                ...
                (t.onDispose(() => {
                  t &&
                    (this._decorations.delete(t) && this._onDecorationRemoved.fire(t), e.dispose());
                }),
            ...
            *getDecorationsAtCell(e, t, i) {
              ...
              for (const h of this._decorations.getKeyIterator(t))
                ((o = null !== (s = h.options.x) && void 0 !== s ? s : 0),
                  (a = o + (null !== (r = h.options.width) && void 0 !== r ? r : 1)),
                  e >= o &&
                    e < a &&
                    (!i || (null !== (n = h.options.layer) && void 0 !== n ? n : 'bottom') === i) &&
                    (yield h));
            }
            forEachDecorationAtCell(e, t, i, s) {
              this._decorations.forEachByKey(t, (t) => {
                ...
                ((a = null !== (r = t.options.x) && void 0 !== r ? r : 0),
                  ...
                  e >= a &&
                    e < h &&
                    (!i || (null !== (o = t.options.layer) && void 0 !== o ? o : 'bottom') === i) &&
                    s(t));
              });
            }
          }
          ...
          class l extends n.Disposable {
              ...
              return (
                null === this._cachedBg &&
                  (this.options.backgroundColor
                    ? (this._cachedBg = s.css.toColor(this.options.backgroundColor))
            ...
            constructor(e) {
              (super(),
                (this.options = e),
                (this.onRenderEmitter = this.register(new r.EventEmitter())),
        ...
        7866: function (e, t, i) {
          ...
          let h,
            c = (t.LogService = class extends n.Disposable {
              get logLevel() {
              ...
              _log(e, t, i) {
                (this._evalLazyOptionalParams(i),
                  e.call(
                    console,
                    (this._optionsService.options.logger ? '' : 'xterm.js: ') + t,
                    ...i
                  ));
              }
              trace(e, ...t) {
                ...
                this._logLevel <= o.LogLevelEnum.TRACE &&
                  this._log(
                    null !==
                      (s =
                        null === (i = this._optionsService.options.logger) || void 0 === i
                          ? void 0
                          : i.trace.bind(this._optionsService.options.logger)) && void 0 !== s
                      ? s
                      : console.log,
                    e,
                    t
                  ...
                  this._log(
                    null !==
                      (s =
                        null === (i = this._optionsService.options.logger) || void 0 === i
                          ? void 0
                          : i.debug.bind(this._optionsService.options.logger)) && void 0 !== s
                      ? s
                      : console.log,
                    e,
                    t
                  ...
                  this._log(
                    null !==
                      (s =
                        null === (i = this._optionsService.options.logger) || void 0 === i
                          ? void 0
                          : i.info.bind(this._optionsService.options.logger)) && void 0 !== s
                      ? s
                      : console.info,
                    e,
                    t
                  ...
                  this._log(
                    null !==
                      (s =
                        null === (i = this._optionsService.options.logger) || void 0 === i
                          ? void 0
                          : i.warn.bind(this._optionsService.options.logger)) && void 0 !== s
                      ? s
                      : console.warn,
                    e,
                    t
                  ...
                  this._log(
                    null !==
                      (s =
                        null === (i = this._optionsService.options.logger) || void 0 === i
                          ? void 0
                          : i.error.bind(this._optionsService.options.logger)) && void 0 !== s
                      ? s
                      : console.error,
                    e,
                    t
          ...
          ((t.LogService = c = s([r(0, o.IOptionsService)], c)),
          ...
          class a extends r.Disposable {
            ...
            _setupOptions() {
              const e = (e) => {
                ...
                i = (e, i) => {
                  if (!(e in t.DEFAULT_OPTIONS)) throw new Error(`No option with key "${e}"`);
                  ((i = this._sanitizeAndValidateOption(e, i)),
                    this.rawOptions[e] !== i &&
                      ((this.rawOptions[e] = i), this._onOptionChange.fire(e)));
                };
              for (const t in this.rawOptions) {
                const s = { get: e.bind(this, t), set: i.bind(this, t) };
            ...
            registerLink(e) {
              ...
              if (void 0 === e.id) {
                const i = t.addMarker(t.ybase + t.y),
                  s = { data: e, id: this._nextId++, lines: [i] };
                return (
                  i.onDispose(() => this._removeMarkerFromLink(s, i)),
                  this._dataByLinkId.set(s.id, s),
                  s.id
                );
              }
              const i = e,
              ...
              const n = t.addMarker(t.ybase + t.y),
                o = { id: this._nextId++, key: this._getEntryIdKey(i), data: i, lines: [n] };
              return (
          ...
          ((t.serviceRegistry = new Map()),
            ...
            (t.createDecorator = function (e) {
              ...
              const r = function (e, t, n) {
                ...
                !(function (e, t, r) {
                  t[i] === t
                    ? t[s].push({ id: e, index: r })
                    : ((t[s] = [{ id: e, index: r }]), (t[i] = t));
                })(r, e, n);
              };
          ...
          t.UnicodeService = class {
            constructor() {
              ((this._providers = Object.create(null)),
                (this._active = ''),
                (this._onChange = new s.EventEmitter()),
        ...
        class d extends n.Disposable {
          constructor(e) {
            ...
            for (const e in this._core.options) {
              const s = { get: t.bind(this, e), set: i.bind(this, e) };
          ...
          get buffer() {
            return (
              this._buffer || (this._buffer = this.register(new a.BufferNamespaceApi(this._core))),
              this._buffer
            );
          }
          get markers() {
